...
void ApiClient::Post(const QUrl &url, const QByteArray &jsonObj)
{
    request = QNetworkRequest(url);
    //QNetworkRequest解析的已知HTTP 類型
    request.setHeader(QNetworkRequest::KnownHeaders::ContentTypeHeader, QVariant("application/json"));
    //post
    networkManager->post(request,jsonObj);
}
...
void ApiClient::Put(const QUrl &url, const QByteArray &jsonObj)
{
    request = QNetworkRequest(url);
    //QNetworkRequest解析的已知HTTP 類型
    request.setHeader(QNetworkRequest::KnownHeaders::ContentTypeHeader, QVariant("application/json"));
